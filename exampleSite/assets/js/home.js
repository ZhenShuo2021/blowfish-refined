var layouts = ["background", "canvas", "profile", "page", "card"];
...
var list_config = ["homepageArticleCard", "homepageArticleList"];

var titles = {
	homepageArticleCard: "card view",
	homepageArticleList: "list view",
};
