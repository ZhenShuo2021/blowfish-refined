...
This will replace the default *tags* and *categories* with *topics*. Refer to the [Hugo Taxonomy docs](https://gohugo.io/content-management/taxonomies/) for more information on naming taxonomies.
