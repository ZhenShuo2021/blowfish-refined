...
The original aim of Blowfish was to develop a theme that was simple and lightweight. The theme is a fork of [Congo](https://github.com/nunocoracao/congo) and expands its initial vision.
...
There's countless other features to explore[^1]. 
[^1]: From being able to display taxonomies on articles and list pages, to using the new `headline` author parameter to customise your homepage. There's also improved JSON-LD structured data which further optimises SEO performance.
